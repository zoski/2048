...
public class LeftArrowAction extends AbstractAction {
    ...
    private static short LEFT = 3;
    private Game2048GraphModel model;
    private GameClient client;

    public LeftArrowAction(Game2048Frame frame, Game2048GraphModel model, GameClient client) {
        this.model = model;
        this.client = client;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (model.isArrowActive()) {
            try {
                client.send(client.move(LEFT), client.getHandler());
